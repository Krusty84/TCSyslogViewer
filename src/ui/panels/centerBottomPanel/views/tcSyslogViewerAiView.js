...
class AiChatWebviewProvider {
  ...
  buildHtml() {
    ...
    return [
      ...
      "      .llm-info { font-size: 0.85rem; opacity: 0.8; }",
      "      .responses {",
      "        border: 1px solid var(--vscode-editorWidget-border);",
      "        background: var(--vscode-editorWidget-background);",
      "        padding: 0.6rem;",
      ...
      "        min-height: 0;",
      "      }",
      "      .entry-header { font-weight: bold; margin-bottom: 0.2rem; }",
      "      .entry-body { margin: 0; white-space: pre-wrap; font-family: var(--vscode-editor-font-family); }",
      "      .status {",
      "        font-size: 0.85rem;",
      "        opacity: 0.8;",
      "        display: flex;",
      ...
      "      }",
      "      .button-spinner { width: 12px; height: 12px; }",
      "      .hidden { display: none; }",
      ...
      '        <span id="llm-info" class="llm-info">LLM info unavailable.</span>',
      '      </div>',
      "    </form>",
